    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            ...
            this.sendMessageExecutor = new BrokerFixedThreadPoolExecutor(
                this.brokerConfig.getSendMessageThreadPoolNums(),//发送消息线程数量默认是1
                this.brokerConfig.getSendMessageThreadPoolNums(),
                1000 * 60,//保持时间
                TimeUnit.MILLISECONDS,
                this.sendThreadPoolQueue,//发送消息线程队列
                new ThreadFactoryImpl("SendMessageThread_"));

            //pull 消息执行器
            this.pullMessageExecutor = new BrokerFixedThreadPoolExecutor(
                this.brokerConfig.getPullMessageThreadPoolNums(),//16+
                this.brokerConfig.getPullMessageThreadPoolNums(),
                1000 * 60,
                TimeUnit.MILLISECONDS,
                this.pullThreadPoolQueue,//pull消息线程池队列
                new ThreadFactoryImpl("PullMessageThread_"));

            //查询消息执行器
            this.queryMessageExecutor = new BrokerFixedThreadPoolExecutor(
                this.brokerConfig.getQueryMessageThreadPoolNums(),//8
                this.brokerConfig.getQueryMessageThreadPoolNums(),
                1000 * 60,
                TimeUnit.MILLISECONDS,
                this.queryThreadPoolQueue,//查询消息线程池队列
            ...
            this.clientManageExecutor = new ThreadPoolExecutor(
                ...
                1000 * 60,
                TimeUnit.MILLISECONDS,
                this.clientManagerThreadPoolQueue,//客户端管理线程池队列
            ...
            //保护broker ，如果量过大，禁用当前组消费者 3分钟执行一次
            this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
                @Override
                public void run() {
                    try {
            ...
            //判断nameserver 地址，如果不为空，则更新，如果为空则重新获取再更新 2分钟
            ...
            } else {//master  打印master 和从服务不同 60 秒
                this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
